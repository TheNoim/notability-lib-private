...
const sessionPath = join(__dirname, '../../Skizzegalvanisches Element (3)/Session.plist');
...
// const sessionPath = join(__dirname, '../../Color Test/Session.plist');
...
// const sessionPath = join(__dirname, '../../Note 4. Sep 2018/Session.plist');
...
writeFileSync(join(__dirname, '../../dist/data.json'), JSON.stringify(session.getDrawInstructions(), undefined, 4));
